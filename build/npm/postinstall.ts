...
import { root, stateFile, computeInputHash, isUpToDate } from './installStateHash.ts';
...
async function main() {
	...
	fs.writeFileSync(stateFile, inputHash);
}
