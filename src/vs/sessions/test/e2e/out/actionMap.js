...
class StepContext {
    vars = new Map();
    set(key, value) { this.vars.set(key, value); }
    get(key) {
...
const STEP_HANDLERS = [
    ...
    // verify <element> has text "<text>"
    {
        ...
        async execute(page, match) {
            ...
            }, { sel: selector, txt: expected }, { timeout: 10_000 });
        },
    },
    ...
    // verify <element> count is <N>
    {
        ...
        async execute(page, match) {
            ...
            await page.waitForFunction(({ sel, n }) => document.querySelectorAll(sel).length === n, { sel: selector, n: expected }, { timeout: 10_000 });
        },
    },
    // verify <element> count is greater than <N>
    {
        ...
        async execute(page, match) {
            ...
            await page.waitForFunction(({ sel, n }) => document.querySelectorAll(sel).length > n, { sel: selector, n: min }, { timeout: 10_000 });
        },
    },
