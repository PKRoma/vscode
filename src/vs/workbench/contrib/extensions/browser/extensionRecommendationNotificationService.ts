...
const stronglyRecommendedModalShownStorageKey = 'extensionsAssistant/stronglyRecommendedModalShown';
const donotShowStronglyRecommendedStorageKey = 'extensionsAssistant/stronglyRecommendedIgnore';
